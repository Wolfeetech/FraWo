...
- `internal_www_root`: `passed`
  ...
  observed_status: `200`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260330_154448\internal_www_root.log`
- `internal_apex_redirect`: `passed`
  expectation: Host frawo-tech.de on 192.168.2.22 should redirect to https://www.frawo-tech.de/.
  observed_status: `308`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260330_154448\internal_apex_redirect.log`
- `internal_radio_player`: `passed`
  ...
  observed_status: `200`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260330_154448\internal_radio_player.log`
- `global_ipv6_www_root`: `passed`
  ...
  observed_status: `200`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260330_154448\global_ipv6_www_root.log`
- `public_ipv4_hairpin`: `failed`
  ...
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260330_154448\public_ipv4_hairpin.log`
