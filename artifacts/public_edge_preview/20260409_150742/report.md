...
- `internal_www_root`: `failed`
  ...
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260409_150742\internal_www_root.log`
- `internal_apex_redirect`: `failed`
  expectation: Host frawo-tech.de on 10.1.0.22 should redirect to https://www.frawo-tech.de/.
  observed_status: `none`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260409_150742\internal_apex_redirect.log`
- `internal_radio_player`: `failed`
  ...
  observed_status: `none`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260409_150742\internal_radio_player.log`
- `global_ipv6_www_root`: `failed`
  ...
  observed_status: `none`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260409_150742\global_ipv6_www_root.log`
- `public_ipv4_hairpin`: `failed`
  ...
  observed_status: `none`
  log: `C:\WORKSPACE\PROJEKTE\Active\FraWo\artifacts\public_edge_preview\20260409_150742\public_ipv4_hairpin.log`
