...
- generated_at: `2026-04-20 15:28:52`
- tailscale_backend_state: `Running`
- local_ipv4_interfaces: `4`
- local_active_dns_sets: `2`
- online_tailscale_peers: `4`
- offline_tailscale_peers: `7`
- routed_tailscale_peers: `2`
- anker_running_containers: `4`
- anker_running_vms: `5`
- stock_running_containers: `7`
- stock_running_vms: `2`
- frontdoors_ok: `0` / `8`
- stock_public_ok: `0` / `4`
...
- `pixel-9-pro.tail150400.ts.net` -> online `false` / ip `100.83.213.17, fd7a:115c:a1e0::683a:d511`
...
- `toolbox.tail150400.ts.net` -> online `true` / ip `100.82.26.53, fd7a:115c:a1e0::e23a:1a35`
...
- `home_assistant` -> `000` (`down`) via `http://100.99.206.128:8443/`
- `odoo` -> `000` (`down`) via `http://100.99.206.128:8444/web/login`
- `nextcloud` -> `000` (`down`) via `http://100.99.206.128:8445/`
- `paperless` -> `000` (`down`) via `http://100.99.206.128:8446/accounts/login/`
- `portal` -> `000` (`down`) via `http://100.99.206.128:8447/`
- `radio` -> `000` (`down`) via `http://100.99.206.128:8448/`
- `media` -> `000` (`down`) via `http://100.99.206.128:8449/`

## Proxmox Anker

- host: `proxmox-anker` / `pve-manager/9.1.6/71482d1833ded40a (running kernel: 6.17.13-2-pve)`
- vmbr0_ipv4: `10.1.0.92/24, 192.168.2.1/24, 192.168.2.10/24`
- transition_router: active `active` / enabled `enabled`
- running_containers: `toolbox, adguard-slave, storage-node, vaultwarden`
- running_vms: `nextcloud, haos, odoo, paperless, PBS-FraWo`
- stopped_vms: `none`
- internal_http_nextcloud: `400`
...
- running_containers: `adguard, npm, wireguard, vaultwarden, pbs, n8n, fileserver`
- running_vms: `azuracast-vm, homeassistant-eltern`
- storage `anker-music`: `disabled` (nfs) / used `N/A`
- storage `hdd-backup`: `active` (dir) / used `85.75%`
- storage `local`: `active` (dir) / used `30.44%`
- storage `local-lvm`: `active` (lvmthin) / used `64.80%`
