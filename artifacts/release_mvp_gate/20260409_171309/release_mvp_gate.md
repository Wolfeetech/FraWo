...
- `device_rollout_verified`: `passed` - Franz Surface Laptop and iPhone have the required direct entrypoints and device-local rollout; last_verified=2026-04-09; evidence=Operator confirmed 2FA admin phone blocker is resolved. Franz iPhone Tailscale login is successful. Franz Surface PC accepted for final Tailscale handover at the scheduled Villa Session. Approved for flight.
