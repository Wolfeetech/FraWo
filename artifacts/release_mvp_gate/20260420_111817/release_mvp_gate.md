...
MVP audit summary: `/mnt/c/Users/Admin/Documents/Private_Networking/artifacts/release_mvp_audit/20260328_072130/summary.tsv`
Manual evidence: `/mnt/c/Users/Admin/Documents/Private_Networking/manifests/release_mvp_gate/manual_checks.json`
...
- `device_rollout_verified`: `passed` - Franz StudioPC and Mobile access have the required entrypoints for productive work; last_verified=2026-04-17; evidence=Agent Repair & Consolidation 2026-04-17: StudioPC established as primary entry point. Toolbox Portal restored at http://100.82.26.53/franz/. Internal routes and document manifest green. Surface Laptop rollout deferred (hardware pending), not blocking internal MVP seal.
...
- `vaultwarden_recovery_material_verified`: `passed` - Vaultwarden recovery material exists offline in two separate copies; last_verified=2026-03-30; evidence=Two physical offline copies verified by operator via !go command.
