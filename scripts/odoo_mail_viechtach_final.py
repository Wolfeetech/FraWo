...
<ul style="margin:0 0 14px;padding-left:22px">
  ...
  <li><b>00_Anschreiben</b> &ndash; nur der Brief, 4 Seiten</li>
  ...
  <li><b>Anlage 3</b> Zahlung 100,00 EUR &middot; <b>Anlage 4</b> Zahlung 32,99 EUR</li>
...
mail = env['mail.mail'].sudo().create({
    'subject': 'Viechtach - vollstaendiges Paket, alles in einer Mail '
               '(Frist 17.09.2026)',
    'body_html': koerper,
    'email_to': EMPFAENGER,
