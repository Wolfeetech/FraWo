...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Update one manual evidence entry in manifests/website_release_gate/manual_checks.json"
    )
    ...
    parser.add_argument(
        "--file",
        default="manifests/website_release_gate/manual_checks.json",
