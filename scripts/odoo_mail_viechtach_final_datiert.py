...
Wolfgang Ferdinand Prinz &middot; <b>Endfassung</b>, datiert 09.09.2026</p>
...
<h3 style="margin:22px 0 6px">Es fehlt nur noch die Unterschrift</h3>
<p style="margin:0 0 8px">Das Datum ist eingetragen (<b>09.09.2026</b>).
Auf <b>Seite 2</b> auf der Linie &uuml;ber dem Namen unterschreiben &ndash;
das ist alles.</p>
...
mail = env['mail.mail'].sudo().create({
    'subject': 'Viechtach - FINAL, datiert 09.09.2026 - nur noch unterschreiben '
               '(Frist 17.09.2026)',
    'body_html': koerper,
    'email_to': EMPFAENGER,
