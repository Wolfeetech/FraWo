...
This folder is the stable entrypoint for the FraWo single source of truth.
The canonical operating state remains in the root and operations documents below.
...
- [Offer Packages](SALES/OFFER_PACKAGES.md) - day rates, travel rules, tax wording, and open sales decisions.

## Repo Governance

- Canonical GitHub repository: `Wolfeetech/FraWo`.
- Canonical local checkout: `C:\Users\Admin\Workspace\Repos\FraWo`.
- Canonical aliases: `C:\Users\Admin\Workspace\FraWo` and `C:\WORKSPACE\FraWo`.
- Legacy/duplicate local checkout: `C:\Users\Admin\Documents\Private_Networking`; keep this as local-only reference until secrets are fully split.
